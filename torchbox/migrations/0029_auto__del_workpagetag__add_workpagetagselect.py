...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'WorkPageTag'
        db.delete_table(u'torchbox_workpagetag')

        # Adding model 'WorkPageTagSelect'
        db.create_table(u'torchbox_workpagetagselect', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='tags', to=orm['torchbox.WorkPage'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='work_page_tag_select', to=orm['torchbox.BlogPageTagList'])),
        ))
        db.send_create_signal(u'torchbox', ['WorkPageTagSelect'])


    def backwards(self, orm):
        # Adding model 'WorkPageTag'
        db.create_table(u'torchbox_workpagetag', (
            ('content_object', self.gf('modelcluster.fields.ParentalKey')(related_name='tagged_items', to=orm['torchbox.WorkPage'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'torchbox_workpagetag_items', to=orm['taggit.Tag'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'torchbox', ['WorkPageTag'])

        # Deleting model 'WorkPageTagSelect'
        db.delete_table(u'torchbox_workpagetagselect')
