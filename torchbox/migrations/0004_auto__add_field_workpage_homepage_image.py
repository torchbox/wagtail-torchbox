...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkPage.homepage_image'
        db.add_column(u'torchbox_workpage', 'homepage_image',
    ...
    def backwards(self, orm):
        # Deleting field 'WorkPage.homepage_image'
        db.delete_column(u'torchbox_workpage', 'homepage_image_id')
