...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonIndexPage.show_in_play_menu'
        db.add_column(u'torchbox_personindexpage', 'show_in_play_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkIndexPage.show_in_play_menu'
        db.add_column(u'torchbox_workindexpage', 'show_in_play_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonIndexPage.show_in_play_menu'
        db.delete_column(u'torchbox_personindexpage', 'show_in_play_menu')

        # Deleting field 'WorkIndexPage.show_in_play_menu'
        db.delete_column(u'torchbox_workindexpage', 'show_in_play_menu')
