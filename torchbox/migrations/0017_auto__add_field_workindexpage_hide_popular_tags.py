...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkIndexPage.hide_popular_tags'
        db.add_column(u'torchbox_workindexpage', 'hide_popular_tags',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkIndexPage.hide_popular_tags'
        db.delete_column(u'torchbox_workindexpage', 'hide_popular_tags')
