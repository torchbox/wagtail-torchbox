...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobPage.salary'
        db.alter_column(u'torchbox_jobpage', 'salary', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'JobPage.location'
        db.alter_column(u'torchbox_jobpage', 'location', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'JobPage.salary'
        db.alter_column(u'torchbox_jobpage', 'salary', self.gf('wagtail.wagtailcore.fields.RichTextField')())

        # Changing field 'JobPage.location'
        db.alter_column(u'torchbox_jobpage', 'location', self.gf('wagtail.wagtailcore.fields.RichTextField')())
