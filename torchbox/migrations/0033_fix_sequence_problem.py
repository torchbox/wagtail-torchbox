...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        if orm.TorchboxImage.objects.count():
            highest_number = db.execute('select id from torchbox_torchboximage order by id desc limit 1;')[0][0]
            db.execute('alter sequence torchbox_torchboximage_id_seq restart with %s;' % (highest_number + 1))
