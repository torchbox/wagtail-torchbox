...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StandardPageContentBlock'
        db.create_table(u'torchbox_standardpagecontentblock', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='content_block', to=orm['torchbox.StandardPage'])),
        ))
        db.send_create_signal(u'torchbox', ['StandardPageContentBlock'])

        # Adding model 'JobIndexPageContentBlock'
        db.create_table(u'torchbox_jobindexpagecontentblock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('content', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='content_block', to=orm['torchbox.JobIndexPage'])),
        ))
        db.send_create_signal(u'torchbox', ['JobIndexPageContentBlock'])
    ...
    def backwards(self, orm):
        # Deleting model 'StandardPageContentBlock'
        db.delete_table(u'torchbox_standardpagecontentblock')

        # Deleting model 'JobIndexPageContentBlock'
        db.delete_table(u'torchbox_jobindexpagecontentblock')
