...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.email'
        db.add_column(u'torchbox_standardpage', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.email'
        db.delete_column(u'torchbox_standardpage', 'email')
