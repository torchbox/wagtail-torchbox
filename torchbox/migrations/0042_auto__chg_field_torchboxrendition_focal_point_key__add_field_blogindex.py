...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TorchboxRendition.focal_point_key'
        db.alter_column(u'torchbox_torchboxrendition', 'focal_point_key', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True, default='', editable=False))
        # Adding field 'BlogIndexPage.show_in_play_menu'
        db.add_column(u'torchbox_blogindexpage', 'show_in_play_menu',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TorchboxRendition.focal_point_key'
        db.alter_column(u'torchbox_torchboxrendition', 'focal_point_key', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Deleting field 'BlogIndexPage.show_in_play_menu'
        db.delete_column(u'torchbox_blogindexpage', 'show_in_play_menu')
    ...
    models = {
        ...
        u'torchbox.blogpage': {
            ...
            'author_left': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'torchbox.homepage': {
            ...
            'hero_video_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'hero_video_poster_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['torchbox.TorchboxImage']"}),
        ...
        u'torchbox.tshirtpage': {
            'Meta': {'object_name': 'TshirtPage', '_ormbases': [u'wagtailcore.Page']},
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['torchbox.TorchboxImage']"}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'})
        },
