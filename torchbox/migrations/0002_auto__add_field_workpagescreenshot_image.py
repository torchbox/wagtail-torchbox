...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkPageScreenshot.image'
        db.add_column(u'torchbox_workpagescreenshot', 'image',
    ...
    def backwards(self, orm):
        # Deleting field 'WorkPageScreenshot.image'
        db.delete_column(u'torchbox_workpagescreenshot', 'image_id')
