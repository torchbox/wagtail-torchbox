...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        #for job in orm['torchbox.JobPage'].objects.all():
        #    job.delete()
        #contenttype = orm['contenttypes.ContentType'].objects.get(app_label='torchbox', model='jobpage')
        #orm['wagtailcore.Page'].objects.filter(content_type=contenttype).delete()
    ...
    models = {
        ...
        u'wagtailimages.image': {
         ...
         'wagtailcore.pagerevision': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['%s']" % 'auth.User', 'null': 'True', 'blank': 'True'})
        }
    }
