...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.main_image'
        db.add_column(u'torchbox_standardpage', 'main_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image']),
                      keep_default=False)

        # Adding field 'StandardPage.heading'
        db.add_column(u'torchbox_standardpage', 'heading',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'StandardPage.quote'
        db.add_column(u'torchbox_standardpage', 'quote',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.main_image'
        db.delete_column(u'torchbox_standardpage', 'main_image_id')

        # Deleting field 'StandardPage.heading'
        db.delete_column(u'torchbox_standardpage', 'heading')

        # Deleting field 'StandardPage.quote'
        db.delete_column(u'torchbox_standardpage', 'quote')
