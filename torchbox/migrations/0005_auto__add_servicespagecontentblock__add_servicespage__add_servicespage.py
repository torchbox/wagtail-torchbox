...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServicesPageContentBlock'
        db.create_table(u'torchbox_servicespagecontentblock', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='content_block', to=orm['torchbox.ServicesPage'])),
        ))
        db.send_create_signal(u'torchbox', ['ServicesPageContentBlock'])

        # Adding model 'ServicesPage'
        db.create_table(u'torchbox_servicespage', (
        ...
        db.send_create_signal(u'torchbox', ['ServicesPage'])

        # Adding model 'ServicesPageRelatedLink'
        db.create_table(u'torchbox_servicespagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['torchbox.ServicesPage'])),
        ))
        db.send_create_signal(u'torchbox', ['ServicesPageRelatedLink'])


    def backwards(self, orm):
        # Deleting model 'ServicesPageContentBlock'
        db.delete_table(u'torchbox_servicespagecontentblock')

        # Deleting model 'ServicesPage'
        db.delete_table(u'torchbox_servicespage')

        # Deleting model 'ServicesPageRelatedLink'
        db.delete_table(u'torchbox_servicespagerelatedlink')
