...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.hero_video_poster_image'
        db.add_column(u'torchbox_homepage', 'hero_video_poster_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['torchbox.TorchboxImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.hero_video_poster_image'
        db.delete_column(u'torchbox_homepage', 'hero_video_poster_image_id')
