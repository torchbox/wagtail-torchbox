...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobPage.salary'
        db.add_column(u'torchbox_jobpage', 'salary',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'JobPage.location'
        db.add_column(u'torchbox_jobpage', 'location',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobPage.salary'
        db.delete_column(u'torchbox_jobpage', 'salary')

        # Deleting field 'JobPage.location'
        db.delete_column(u'torchbox_jobpage', 'location')
    ...
    models = {
        ...
        u'torchbox.jobpage': {
            ...
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'salary': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'})
        },
