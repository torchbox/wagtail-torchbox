...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.show_in_play_menu'
        db.add_column(u'torchbox_standardpage', 'show_in_play_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.show_in_play_menu'
        db.delete_column(u'torchbox_standardpage', 'show_in_play_menu')
