...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HomePage.hero_video_id'
        db.alter_column(u'torchbox_homepage', 'hero_video_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'HomePage.hero_video_id'
        db.alter_column(u'torchbox_homepage', 'hero_video_id', self.gf('django.db.models.fields.IntegerField')(default=1))
