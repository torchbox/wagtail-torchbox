...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPage.author_left'
        db.add_column(u'torchbox_blogpage', 'author_left',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPage.author_left'
        db.delete_column(u'torchbox_blogpage', 'author_left')
