...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.middle_break'
        db.add_column(u'torchbox_standardpage', 'middle_break',
                      self.gf('wagtail.wagtailcore.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.middle_break'
        db.delete_column(u'torchbox_standardpage', 'middle_break')
