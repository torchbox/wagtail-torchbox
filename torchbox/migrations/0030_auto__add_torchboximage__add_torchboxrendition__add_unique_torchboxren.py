...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TorchboxImage'
        db.create_table(u'torchbox_torchboximage', (
            ...
            ('focal_point_x', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('focal_point_y', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('focal_point_width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('focal_point_height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('credit', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'torchbox', ['TorchboxImage'])

        # Adding model 'TorchboxRendition'
        db.create_table(u'torchbox_torchboxrendition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['wagtailimages.Filter'])),
            ('file', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('width', self.gf('django.db.models.fields.IntegerField')()),
            ('height', self.gf('django.db.models.fields.IntegerField')()),
            ('focal_point_key', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='renditions', to=orm['torchbox.TorchboxImage'])),
        ))
        db.send_create_signal(u'torchbox', ['TorchboxRendition'])

        # Adding unique constraint on 'TorchboxRendition', fields ['image', 'filter', 'focal_point_key']
        db.create_unique(u'torchbox_torchboxrendition', ['image_id', 'filter_id', 'focal_point_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'TorchboxRendition', fields ['image', 'filter', 'focal_point_key']
        db.delete_unique(u'torchbox_torchboxrendition', ['image_id', 'filter_id', 'focal_point_key'])

        # Deleting model 'TorchboxImage'
        db.delete_table(u'torchbox_torchboximage')

        # Deleting model 'TorchboxRendition'
        db.delete_table(u'torchbox_torchboxrendition')
    ...
    models = {
        ...
        u'torchbox.standardpage': {
            ...
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'main_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
        ...
        u'torchbox.workpage': {
            ...
            'body': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            'homepage_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
            'intro': ('wagtail.wagtailcore.fields.RichTextField', [], {'blank': 'True'}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
