...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'torchbox_clients')

        # Adding model 'StandardPageClients'
        db.create_table(u'torchbox_standardpageclients', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='clients', to=orm['torchbox.StandardPage'])),
        ...
        db.send_create_signal(u'torchbox', ['StandardPageClients'])


    def backwards(self, orm):
        # Adding model 'Clients'
        db.create_table(u'torchbox_clients', (
        ...
        db.send_create_signal(u'torchbox', ['Clients'])

        # Deleting model 'StandardPageClients'
        db.delete_table(u'torchbox_standardpageclients')
