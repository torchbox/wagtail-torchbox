...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogIndexPageRelatedLink.link_external'
        db.alter_column(u'torchbox_blogindexpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'WorkPageRelatedLink.link_external'
        db.alter_column(u'torchbox_workpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'StandardPageRelatedLink.link_external'
        db.alter_column(u'torchbox_standardpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'PersonPageRelatedLink.link_external'
        db.alter_column(u'torchbox_personpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'BlogPageRelatedLink.link_external'
        db.alter_column(u'torchbox_blogpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'HomePageCarouselItem.link_external'
        db.alter_column(u'torchbox_homepagecarouselitem', 'link_external', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'BlogIndexPageRelatedLink.link_external'
        db.alter_column(u'torchbox_blogindexpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'WorkPageRelatedLink.link_external'
        db.alter_column(u'torchbox_workpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'StandardPageRelatedLink.link_external'
        db.alter_column(u'torchbox_standardpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'PersonPageRelatedLink.link_external'
        db.alter_column(u'torchbox_personpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'BlogPageRelatedLink.link_external'
        db.alter_column(u'torchbox_blogpagerelatedlink', 'link_external', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'HomePageCarouselItem.link_external'
        db.alter_column(u'torchbox_homepagecarouselitem', 'link_external', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
