...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobIndexPageJob'
        db.create_table(u'torchbox_jobindexpagejob', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='job', to=orm['torchbox.JobIndexPage'])),
        ...
        db.send_create_signal(u'torchbox', ['JobIndexPageJob'])


    def backwards(self, orm):
        # Deleting model 'JobIndexPageJob'
        db.delete_table(u'torchbox_jobindexpagejob')
