...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HomePage.hero_video'
        db.delete_column(u'torchbox_homepage', 'hero_video')

        # Adding field 'HomePage.hero_video_id'
        db.add_column(u'torchbox_homepage', 'hero_video_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HomePage.hero_video'
        db.add_column(u'torchbox_homepage', 'hero_video',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'HomePage.hero_video_id'
        db.delete_column(u'torchbox_homepage', 'hero_video_id')
    ...
    models = {
        ...
        u'torchbox.homepage': {
            ...
            'hero_video_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
