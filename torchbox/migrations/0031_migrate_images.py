...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for image in orm['wagtailimages.Image'].objects.all():
            torchboximage = orm.TorchboxImage()
            torchboximage.id = image.id
            torchboximage.title = image.title
            torchboximage.file = image.file
            torchboximage.width = image.width
            torchboximage.height = image.height
            torchboximage.created_at = image.created_at
            torchboximage.uploaded_by_user = image.uploaded_by_user
            torchboximage.focal_point_x = image.focal_point_x
            torchboximage.focal_point_y = image.focal_point_y
            torchboximage.focal_point_width = image.focal_point_width
            torchboximage.focal_point_height = image.focal_point_height
            torchboximage.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for torchboximage in orm.TorchboxImage.objects.all():
            try:
                torchboximage.delete()
            except torchboximage.DoesNotExist:
                pass
