...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TshirtPage'
        db.create_table(u'torchbox_tshirtpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['torchbox.TorchboxImage'])),
        ))
        db.send_create_signal(u'torchbox', ['TshirtPage'])


    def backwards(self, orm):
        # Deleting model 'TshirtPage'
        db.delete_table(u'torchbox_tshirtpage')
