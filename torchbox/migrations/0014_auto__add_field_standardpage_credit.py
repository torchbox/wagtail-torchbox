...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardPage.credit'
        db.add_column(u'torchbox_standardpage', 'credit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardPage.credit'
        db.delete_column(u'torchbox_standardpage', 'credit')
