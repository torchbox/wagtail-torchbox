...
def update_contenttypes(apps, schema_editor):
    ...
    blog_index_prev, created = ContentType.objects.get_or_create(app_label='torchbox', model='blogindexpage')
    blog_index_next, created = ContentType.objects.get_or_create(app_label='blog', model='blogindexpage')
    blog_page_prev, created = ContentType.objects.get_or_create(app_label='torchbox', model='blogpage')
    blog_page_next, created = ContentType.objects.get_or_create(app_label='blog', model='blogpage')

    Page.objects.filter(content_type=blog_index_prev).update(content_type=blog_index_next)
...
def reverse_update_contenttypes(apps, schema_editor):
    ...
    Page.objects.filter(content_type=blog_index_next).update(content_type=blog_index_prev)
    ...
    state_operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_page_tag_select', to='torchbox.BlogPageTagList')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
