...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('torchbox', '0142_create_external_story_block'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='addresses',
            field=wagtail.fields.StreamField([('address', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(blank=True)), ('address', wagtail.blocks.RichTextBlock(blank=True))]))], blank=True, use_json_field=True),
        ),
        migrations.AlterField(
            model_name='mainmenu',
            name='menu',
            field=wagtail.fields.StreamField([('items', wagtail.blocks.StructBlock([('page', wagtail.blocks.PageChooserBlock()), ('subitems', wagtail.blocks.StreamBlock([('related_listing_page', wagtail.blocks.PageChooserBlock())], blank=True, null=True))]))], blank=True, use_json_field=True),
        ),
        migrations.AlterField(
