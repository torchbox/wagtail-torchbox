...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='intro_subtitle',
            field=models.CharField(blank=True, max_length=255, verbose_name='intro subtitle'),
        ),
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='intro_related_links', to='torchbox.MarketingLandingPage'),
        ),
        migrations.AddField(
            model_name='marketinglandingpageheaderrelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='header_related_links', to='torchbox.MarketingLandingPage'),
        ),
    ]
