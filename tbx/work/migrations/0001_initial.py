...
def update_contenttypes(apps, schema_editor):
    ...
    work_index_prev, created = ContentType.objects.get_or_create(app_label='torchbox', model='workindexpage')
    work_index_next, created = ContentType.objects.get_or_create(app_label='work', model='workindexpage')
    work_page_prev, created = ContentType.objects.get_or_create(app_label='torchbox', model='workpage')
    work_page_next, created = ContentType.objects.get_or_create(app_label='work', model='workpage')

    Page.objects.filter(content_type=work_index_prev).update(content_type=work_index_next)
...
def reverse_update_contenttypes(apps, schema_editor):
    ...
    Page.objects.filter(content_type=work_index_next).update(content_type=work_index_prev)
    ...
    state_operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', wagtail.core.fields.RichTextField(blank=True, verbose_name='Intro (deprecated. Use streamfield instead)')),
                ...
                ('homepage_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='torchbox.TorchboxImage')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_author', to='work.WorkPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work_page_tag_select', to='torchbox.BlogPageTagList')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
