...
def update_contenttypes(apps, schema_editor):
    ...
    person_index_prev, created = ContentType.objects.get_or_create(app_label='torchbox', model='personindexpage')
    person_index_next, created = ContentType.objects.get_or_create(app_label='people', model='personindexpage')
    person_page_prev, created = ContentType.objects.get_or_create(app_label='torchbox', model='personpage')
    person_page_next, created = ContentType.objects.get_or_create(app_label='people', model='personpage')

    Page.objects.filter(content_type=person_index_prev).update(content_type=person_index_next)
    Page.objects.filter(content_type=person_page_prev).update(content_type=person_page_next)
...
def reverse_update_contenttypes(apps, schema_editor):
    ...
    Page.objects.filter(content_type=person_index_next).update(content_type=person_index_prev)
    Page.objects.filter(content_type=person_page_next).update(content_type=person_page_prev)
